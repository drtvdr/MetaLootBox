...
interface IFactory {
    ...
    /**
     * @dev Returns wether the option ID can be minted. Can return false if the developer wishes to
    ...
    /**
     * @dev Returns URL specifying some metadata about the option. This metadata can be of the
