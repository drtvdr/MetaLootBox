...
contract MetaFactory is IFactory, Ownable, ReentrancyGuard {
    using Strings for string;
    using SafeMath for uint256;

    address public nftAddress;
    string internal constant baseMetadataURI = "http://example.com";
    ...
    /**
     * Three different options for minting MetaCollectibles (basic, premium, and gold).
     */
    enum Option {
        Basic,
        Premium,
    ...
    function _mint(
        ...
        MetaCollectible nftContract = MetaCollectible(nftAddress);
